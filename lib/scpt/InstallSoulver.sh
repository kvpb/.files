...
unzip soulver.zip -d /Applications # Unzip the Soulver zip archive to the system applications folder.
mv soulver.zip ${HOME}/Downloads/ # Move the Soulver zip archive to the current user's downloads folder.
